...
# sphinx-quickstart on Wed Nov  2 23:27:52 2016.
#
...
for directory in dirs:
    if not directory.startswith(('.', '__')) and \
            os.path.isdir(os.path.join(build_path, directory)):
        addons += directory
print('dirs=%s' % dirs)
...
copyright = u'2016, Odoo Community Association'
author = u'Odoo Community Association'
...
htmlhelp_basename = 'OdooCommunitydoc'
...
latex_documents = [
    (master_doc, 'OdooCommunity.tex', u'Odoo Community Project Documentation',
...
man_pages = [
    (master_doc, 'odoocommunity', u'Odoo Community Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OdooCommunity', u'Odoo Community Documentation',
     author, 'OdooCommunity', 'One line description of project.',
     'Miscellaneous'),
]
